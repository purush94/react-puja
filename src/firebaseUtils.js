...
//         fields: [
//             "A link to the recorded video of Shaktipeeth Jwala Devi Puja and Yagya will be provided to you.",
//             "Family Members' Name and Gotra (8 Members) will be chanted during the Puja Sankalp in Shaktipeeth Jwala Devi.",
...
//     const collectionRef = collection(db, 'jwalaDevi1'); // Collection name: nainaDevi

//     for (const item of data) {
//         // try {
//         // const docRef = await addDoc(collectionRef, item);
//         // console.log(`Document added with ID: ${docRef.id}`);
//         addDoc(collectionRef, item).then(function (docRef) {
//             console.log(`Document added with ID: ${docRef.id}`);
//         });
//         // } catch (error) {
...
// export default addDataToFirestore(dataToSave);
